...
public class KafkaConsumer {
    private Map<String, Object> getBaseKafkaConfig() {
        ...
        config.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.tech.ian.order.config.kafka.dto.OrderEventDto");

        return config;
    }

    public ConsumerFactory<String, OrderEventDto> consumerFactory() {
        return new DefaultKafkaConsumerFactory<>(getBaseKafkaConfig());
    }
